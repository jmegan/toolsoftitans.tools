...
! function(a) {
    ...
    var t = function(a) {
        var e = a.h;
        if (!a.CORE_VERSION || !e.compareVersions(t.REQUIRE_CORE_VERSION, a.CORE_VERSION)) throw new Error("[MixItUp Pagination] MixItUp Pagination " + t.EXTENSION_VERSION + " requires at least MixItUp " + t.REQUIRE_CORE_VERSION);
        a.ConfigClassNames.registerAction("afterConstruct", "pagination", function() {
            ...
            this.generatePageList = !0, this.generatePageStats = !0, this.maintainActivePage = !0, this.loop = !1, this.hidePageListIfSinglePage = !1, this.hidePageStatsIfSinglePage = !1, this.limit = -1, this.maxPagers = 5, e.seal(this)
            ...
            this.pageNumber = -1, this.classNames = "", this.classList = [], this.isDisabled = !1, this.isPrev = !1, this.isNext = !1, this.isPageLink = !1, this.isTruncationMarker = !1, e.seal(this)
        }, a.ModelPageStats = function() {
            this.startPageAt = -1, this.endPageAt = -1, this.totalTargets = -1, e.seal(this)
        ...
        }), a.controlDefinitions.push(new a.ControlDefinition("pager", "[data-page]", (!0), "pageList")), a.Control.registerFilter("commandsHandleClick", "pagination", function(a, t) {
            var i = this,
                n = {},
                s = "",
                o = -1,
                ...
                r = null,
                l = -1;
            if (!i.selector || "[data-page]" !== i.selector) return a;
            for (r = e.closestParent(t.target, i.selector, !0, i.bound[0].dom.document), l = 0; g = i.bound[l]; l++) n = a[l], !g.config.pagination || g.config.pagination.limit < 0 || g.config.pagination.limit === 1 / 0 ? a[l] = null : !r || e.hasClass(r, g.classNamesPager.active) || e.hasClass(r, g.classNamesPager.disabled) ? a[l] = null : (s = r.getAttribute("data-page"), "prev" === s ? n.paginate = "prev" : "next" === s ? n.paginate = "next" : o && (n.paginate = parseInt(s)), g.lastClicked && (g.lastClicked = r));
            return a
        }), a.CommandMultimix.registerAction("afterConstruct", "pagination", function() {
            this.paginate = null
        }), a.CommandPaginate = function() {
            this.page = -1, this.limit = -1, this.action = "", this.anchor = null, e.seal(this)
            ...
            var e = this;
            return e.config.pagination.limit < 0 ? a : (a.newPagination = t.activePagination, a)
        }), a.Mixer.registerFilter("stateGetInitialState", "pagination", function(t) {
            var e = this;
            return e.config.pagination.limit < 0 ? t : (t.activePagination = new a.CommandPaginate, t.activePagination.page = e.config.load.page, t.activePagination.limit = e.config.pagination.limit, t)
            ...
            if (!(t.config.pagination.limit < 0) && t.config.pagination.generatePageList) {
                ...
                t.dom.pageList = e.querySelector(t.config.selectors.pageList), t.dom.pageStats = e.querySelector(t.config.selectors.pageStats)
            }
        }), a.Mixer.registerFilter("stateBuildState", "pagination", function(a, t) {
            var e = this;
            return e.config.pagination.limit < 0 ? a : (a.activePagination = t.newPagination, a.totalPages = t.newTotalPages, a)
        }), a.Mixer.registerFilter("instructionParseMultimixArgs", "pagination", function(t) {
            var e = this;
            return e.config.pagination.limit < 0 ? t : (!t.command.paginate || t.command.paginate instanceof a.CommandPaginate || (t.command.paginate = e.parsePaginateArgs([t.command.paginate]).command), t)
            ...
            if (!(t.config.pagination.limit < 0)) {
                if (a.newTotalPages = a.newPagination.limit ? Math.max(Math.ceil(a.matching.length / a.newPagination.limit), 1) : 1, t.config.pagination.maintainActivePage && (a.newPagination.page = a.newPagination.page > a.newTotalPages ? a.newTotalPages : a.newPagination.page), t.config.pagination.limit = a.newPagination.limit, a.newPagination.anchor) {
                    ...
                    e = r, i = r + a.newPagination.limit - 1
                } else e = a.newPagination.limit * (a.newPagination.page - 1), i = a.newPagination.limit * a.newPagination.page - 1, isNaN(e) && (e = 0);
                if (!(a.newPagination.limit < 0)) {
                    for (r = 0; o = a.show[r]; r++) r >= e && r <= i ? n.push(o) : s.push(o);
        ...
        }), a.Mixer.registerFilter("operationUnmappedGetOperation", "pagination", function(t, i) {
            var n = this;
            return n.config.pagination.limit < 0 ? t : (t.startState = n.state, t.startPagination = n.state.activePagination, t.startTotalPages = n.state.totalPages, t.newPagination = new a.CommandPaginate, t.newPagination.limit = t.startPagination.limit, t.newPagination.page = t.startPagination.page, i.paginate ? n.parsePaginateCommand(i.paginate, t) : (i.filter || i.sort) && (e.extend(t.newPagination, t.startPagination), n.config.pagination.maintainActivePage ? t.newPagination.page = n.state.activePagination.page : t.newPagination.page = 1), t)
        }), a.Mixer.registerFilter("operationMappedGetOperation", "pagination", function(a, t, e) {
            var i = this;
            return i.config.pagination.limit < 0 ? a : e ? a : (i.config.pagination.generatePageList && i.dom.pageList && i.renderPageList(a), i.config.pagination.generatePageStats && i.dom.pageStats && i.renderPageStats(a), a)
        }), a.Mixer.extend({
            parsePaginateCommand: function(t, e) {
                ...
                } else "next" === t.action ? e.newPagination.page = i.getNextPage() : "prev" === t.action ? e.newPagination.page = i.getPrevPage() : t.anchor && (e.newPagination.anchor = t.anchor);
                t.limit > -1 && (e.newPagination.limit = t.limit), e.newPagination.limit !== e.startPagination.limit && (e.newTotalPages = e.newPagination.limit ? Math.max(Math.ceil(e.startState.matching.length / e.newPagination.limit), 1) : 1), (e.newPagination.limit <= 0 || e.newPagination.limit === 1 / 0) && (e.newPagination.page = 1)
            },
    ...
    if (t.TYPE = "mixitup-extension", t.NAME = "mixitup-pagination", t.EXTENSION_VERSION = "3.1.0", t.REQUIRE_CORE_VERSION = "^3.1.2", "object" == typeof exports && "object" == typeof module) module.exports = t;
