...
! function(e) {
    ...
    var t = function(e) {
        var i = e.h;
        if (!e.CORE_VERSION || !i.compareVersions(t.REQUIRE_CORE_VERSION, e.CORE_VERSION)) throw new Error("[MixItUp Multifilter] MixItUp Multifilter v" + t.EXTENSION_VERSION + " requires at least MixItUp v" + t.REQUIRE_CORE_VERSION);
        e.ConfigMultifilter = function() {
            ...
            this.name = "", this.dom = new e.FilterGroupDom, this.activeSelectors = [], this.activeToggles = [], this.handler = null, this.mixer = null, this.logic = "or", this.parseOn = "change", this.keyupTimeout = -1, i.seal(this)
        }, i.extend(e.FilterGroup.prototype, {
            init: function(e, t) {
                var i = this,
                    r = e.getAttribute("data-logic");
                i.dom.el = e, this.name = i.dom.el.getAttribute("data-filter-group") || "", i.cacheDom(), i.dom.form && i.enableButtons(), i.mixer = t, (r && "and" === r.toLowerCase() || "and" === t.config.multifilter.logicWithinGroup) && (i.logic = "and"), i.bindEvents()
            },
            cacheDom: function() {
                var e = this;
            ...
            bindEvents: function() {
                ...
                }, i.on(e.dom.el, "click", e.handler), i.on(e.dom.el, "change", e.handler), i.on(e.dom.el, "keyup", e.handler), e.dom.form && (i.on(e.dom.form, "reset", e.handler), i.on(e.dom.form, "submit", e.handler))
            },
            unbindEvents: function() {
                var e = this;
                i.off(e.dom.el, "click", e.handler), i.off(e.dom.el, "change", e.handler), i.off(e.dom.el, "keyup", e.handler), e.dom.form && (i.off(e.dom.form, "reset", e.handler), i.off(e.dom.form, "submit", e.handler)), e.handler = null
            },
            handleClick: function(e) {
                var t = this,
                    ...
                    l = -1,
                    n = "";
                r && ((o = t.mixer.config.selectors.control) && !r.matches(o) || (e.stopPropagation(), r.matches("[data-filter]") ? (n = r.getAttribute("data-filter"), t.activeSelectors = [n]) : r.matches("[data-toggle]") && (n = r.getAttribute("data-toggle"), (l = t.activeToggles.indexOf(n)) > -1 ? t.activeToggles.splice(l, 1) : t.activeToggles.push(n), "and" === t.logic ? t.activeSelectors = [t.activeToggles] : t.activeSelectors = t.activeToggles), t.updateControls(), "change" === t.mixer.config.multifilter.parseOn && t.mixer.parseFilterGroups()))
            },
            ...
            handleKeyup: function(e) {
                var t = this,
                    i = e.target;
                return "change" !== t.mixer.config.multifilter.parseOn ? void t.mixer.getSingleValue(i) : (clearTimeout(t.keyupTimeout), void(t.keyupTimeout = setTimeout(function() {
            ...
            handleFormEvent: function(t) {
                var i = this,
                    ...
                    o = null,
                    l = -1;
                if ("submit" === t.type && t.preventDefault(), "reset" === t.type && (i.activeToggles = [], i.activeSelectors = [], i.updateControls()), i.mixer.multifilterFormEventTracker) r = i.mixer.multifilterFormEventTracker;
                else
                    for (r = i.mixer.multifilterFormEventTracker = new e.MultifilterFormEventTracker, r.form = t.target, l = 0; o = i.mixer.filterGroups[l]; l++) o.dom.form === t.target && r.totalBound++;
                t.target === r.form && (r.totalHandled++, r.totalHandled === r.totalBound && (i.mixer.multifilterFormEventTracker = null, "submit" !== t.type && "change" !== i.mixer.config.multifilter.parseOn || i.mixer.parseFilterGroups()))
            },
            getSingleValue: function(e) {
                ...
                if (e.type.match(/text|search|password/g)) {
                    if (i = e.getAttribute("data-search-attribute"), !i) throw new Error("[MixItUp MultiFilter] A valid `data-search-attribute` must be present on text inputs");
                ...
                "string" == typeof e.value && (t.activeSelectors = [r])
            },
            getMultipleValues: function(e) {
                ...
                "and" === t.logic && (i = [i]), t.activeSelectors = i
            },
            updateControls: function(e, t) {
                var i = this,
                    ...
                    o = "filter",
                    l = -1;
                for (e = e || i.dom.el.querySelectorAll("[data-filter], [data-toggle]"), t = t || !1, l = 0; r = e[l]; l++) r.getAttribute("data-toggle") && (o = "toggle"), i.updateControl(r, o, t)
            },
            updateControl: function(e, t, r) {
                var o = this,
                    l = e.getAttribute("data-" + t),
                    n = "";
                n = i.getClassname(o.mixer.config.classNames, t, o.mixer.config.classNames.modifierActive), o.activeSelectors.indexOf(l) > -1 ? (i.addClass(e, n), r && o.activeToggles.push(l)) : i.removeClass(e, n)
            },
            updateUi: function() {
                var e = this,
                    ...
                    o = null,
                    l = -1;
                for (t.length && (e.activeToggles = [], e.updateControls(t, !0)), l = 0; o = i[l]; l++) switch (r = e.activeSelectors.indexOf(o.value) > -1, o.tagName.toLowerCase()) {
                    case "option":
                        o.selected = r;
                        break;
                    case "input":
            ...
            parseParseFilterGroupsArgs: function(t) {
                var r = this,
                    ...
                    l = null,
                    n = -1;
                for (o.animate = r.config.animation.enable, o.command = new e.CommandFilter, n = 0; n < t.length; n++) l = t[n], "boolean" == typeof l ? o.animate = l : "function" == typeof l && (o.callback = l);
                return i.freeze(o), o
            },
            ...
            setFilterGroupSelectors: function(e, t) {
                var i = this,
                    r = null;
                if (t = Array.isArray(t) ? t : [t], "undefined" == typeof(r = i.filterGroupsHash[e])) throw new Error('[MixItUp MultiFilter] No filter group could be found with the name "' + e + '"');
                r.activeSelectors = t.slice(), r.updateUi()
            },
            getFilterGroupSelectors: function(e) {
                ...
                return i.activeSelectors.slice()
            }
        }), e.Facade.registerAction("afterConstruct", "multifilter", function(e) {
            this.parseFilterGroups = e.parseFilterGroups.bind(e), this.setFilterGroupSelectors = e.setFilterGroupSelectors.bind(e), this.getFilterGroupSelectors = e.getFilterGroupSelectors.bind(e)
        })
    };
    if (t.TYPE = "mixitup-extension", t.NAME = "mixitup-multifilter", t.EXTENSION_VERSION = "3.2.0", t.REQUIRE_CORE_VERSION = "^3.1.2", "object" == typeof exports && "object" == typeof module) module.exports = t;
